...
public class CameraController : MonoBehaviour
{
    ...
    public List<GameObject> Targets = new List<GameObject>(); //Make this work somehow
    ...
    void FollowMidpoint()
    {
        Vector3 midpoint = (Targets[0].transform.position + Targets[1].transform.position) / 2f; //Adjust for list
    ...
    void AdjustFOV()
    {
        float distance = Vector3.Distance(Targets[0].transform.position, Targets[1].transform.position); //Adjust for list
